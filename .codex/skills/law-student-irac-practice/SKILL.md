...
description: >
  Codex CLI version of law-student:irac-practice. Grade an IRAC essay for structure, issue-spotting, rule accuracy, analysis depth, and organization. Does NOT rewrite the essay or show a model answer; tracks patterns across sessions. Use when the user says "grade my IRAC", "check my essay", or "I wrote this, give me feedback".
argument-hint: "[paste essay OR path to draft OR --generate-hypo]"
---

# Codex Adaptation Notes

This skill was converted from `law-student:irac-practice` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `law-student-irac-practice`, or by describing the legal task in natural language.
...
# Codex skill: law-student-irac-practice

1. Load `~/.codex/claude-for-legal/law-student/CLAUDE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.codex/claude-for-legal/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.codex/claude-for-legal/law-student/CLAUDE.md` → current classes, exam formats, outline locations, learning style
- `~/.codex/claude-for-legal/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Append to `~/.codex/claude-for-legal/law-student/irac-sessions/[student]/tracker.md`:
