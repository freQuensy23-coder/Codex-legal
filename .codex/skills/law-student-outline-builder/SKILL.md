...
description: >
  Codex CLI version of law-student:outline-builder. Build or extend a course outline in your format, from class notes and casebook. Scaffolds — it does not write the outline for you. Use when the user says "outline [subject]", "add to my outline", "build an outline from", or points at class materials.
argument-hint: "[subject, or point at class notes/casebook section]"
---

# Codex Adaptation Notes

This skill was converted from `law-student:outline-builder` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `law-student-outline-builder`, or by describing the legal task in natural language.
...
# Codex skill: law-student-outline-builder

1. Load `~/.codex/claude-for-legal/law-student/CLAUDE.md` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `~/.codex/claude-for-legal/law-student/CLAUDE.md` → Seed materials, or an earlier section of the outline being extended), and
...
`~/.codex/claude-for-legal/law-student/CLAUDE.md` → outline preferences (format, depth, existing outlines location).
