...
description: >
  Codex CLI version of product-legal:customize. Guided customization of your product counsel practice profile — change one thing without re-running the whole cold-start interview. Adjust risk calibration, escalation contacts, launch review framework, marketing claims posture, or matter workspace paths. Use when the user says "change my [thing]", "update my profile", "edit my framework", "retune my calibration", or "customize".
argument-hint: "[section name, or describe what you want to change]"
---

# Codex Adaptation Notes

This skill was converted from `product-legal:customize` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `product-legal-customize`, or by describing the legal task in natural language.

Configuration for this fork uses `~/.codex/claude-for-legal/product-legal/CLAUDE.md` instead of the Claude plugin config directory. Shared organization facts live in `~/.codex/claude-for-legal/company-profile.md`.
...
# Codex skill: product-legal-customize
...
1. **Read the config.** Read
   `~/.codex/claude-for-legal/product-legal/CLAUDE.md`
